...
\begin{document}
    ...
    Cependant, même si on peut définir une notion de lettres intutiles (des deux côtés du curseur) similairement à ce qui est fait en section 2, la technique constituant à borner uniformément leur quantité (lemme \ref{bk}) ne peut fonctionner.
