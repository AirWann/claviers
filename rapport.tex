...
\begin{document}
    ...
    \end{configétats}
    \erwann{on en a parlé irl, mais j'ai oublié ce qu'on avait dit... (désolé). Moi c'était formulé comme ça dans mon sujet de stage, et c'est vrai que configuration tout court, c'est pour les claviers sans états...}
