...
\begin{document}
    ...
    \begin{defétats}[Clavier à état]
        ...
        \begin{itemize}
            ...
            \item $T$ est un clavier (ensemble de touches)
    ...
    L'éxécution écrivant $ababc$ est : $\varepsilon \rightarrow abc \rightarrow ab \rightarrow ababc$, mais le $b$ du deuxième état n'est \emph{pas} utile, car il est effacé à l'étape suivante (même s'il est remplacé par un autre $b$). \smallskip
