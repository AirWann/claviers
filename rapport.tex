...
\begin{document}
    ...
    On crée cet automate comme suit\footnote{on s'autorise à avoir des transitions dans l'automate étiquetées par des mots. Il n'est pas difficile d'en extraire un automate étiqueté par des lettres.} :
        \begin{itemize}
