...
\cortoin{Suggestion :
	...
	\textit{Figure à adapter en rajoutant les transitions utiles entre les pas}
	...
	Quand aux pas, ils peuvent être simulés par un système à compteurs 
	\textit{Description du système à un compteur en question, \textbf{en faisant deux cas, un général et un pour le premier pas, qui peut faire des transitions non efficientes}}
